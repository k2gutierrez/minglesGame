...
export default function OvenRoom() {
  ...
  return (
    <>
      ...
      <p className="mt-2 text-black text-md font-[family-name:var(--font-hogfish)]">YOU'VE ENTERED THE OVEN ROOM</p>
      ...
      <div className="mt-5 mb-10 flex items-center justify-center">
        <button className={cls(styles.backColor, "text-sm p-2 mx-5 w-32 p-1 rounded-xl")} onClick={firstChoice} >A. Heat radiates from a brightly lit corridor ahead.</button>
        <button className={cls(styles.backColor, "text-sm p-2 mx-5 w-32 p-1 rounded-xl")} onClick={secondChoice} >B. A cool draft signals another way out.</button>
      </div>
    </>
  )
}
