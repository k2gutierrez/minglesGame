    ...
    <>
      {loading == true ? (
        ...
        <>
          ...
          <p className="mt-2 text-black text-md font-[family-name:var(--font-hogfish)]">{message == "" ? "YOU'VE ENTERED THE FERMENTATION ROOM" : "YOU'RE STILL IN THE FERMENTATION ROOM"}</p>
