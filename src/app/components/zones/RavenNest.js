...
export default function RavenNest() {
  ...
  const c1 = async () => {
    Choice(tokenId, onlyChoice, collection, 0)
  }

  const c2 = async () => {
    Choice(tokenId, onlyChoice, collection, 1)
  }

  const c3 = async () => {
    Choice(tokenId, onlyChoice, collection, 2)
  }

  const c4 = async () => {
    Choice(tokenId, onlyChoice, collection, 3)
  }

  const c5 = async () => {
    Choice(tokenId, onlyChoice, collection, 4)
  }
