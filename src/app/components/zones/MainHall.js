...
export default function MainHall() {
  ...
  return (
    <>
      ...
      <p className="mt-2 text-black text-md font-[family-name:var(--font-hogfish)]">YOU'VE ENTERED THE MAIN HALL</p>
      ...
      <div className="mt-5 mb-10 flex items-center justify-center">
        <button className={cls(styles.backColor, "text-sm p-2 mx-5 w-32 p-1 rounded-xl")} onClick={firstChoice} >A. Warm light and crackling sounds draw you forward.</button>
        <button className={cls(styles.backColor, "text-sm p-2 mx-5 w-32 p-1 rounded-xl")} onClick={secondChoice} >B. A strong tequila scent beckons from a nearby chamber.</button>
      </div>
    </>
  )
}
