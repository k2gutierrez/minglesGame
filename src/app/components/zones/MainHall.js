      ...
      {loading == true ?
        (
          ...
          <>
            ...
            <p className="mt-2 text-black text-md font-[family-name:var(--font-hogfish)]">{message == "" ? "YOU'VE ENTERED THE MAIN HALL" : "YOU'RE STILL IN THE MAIN HALL"}</p>
            ...
            <div className="mt-5 mb-10 flex items-center justify-center">
              <button className={cls(styles.backColor, "text-sm p-2 mx-5 w-32 p-1 rounded-xl")} onClick={c1} >A. Warm light and crackling sounds draw you forward.</button>
              <button className={cls(styles.backColor, "text-sm p-2 mx-5 w-32 p-1 rounded-xl")} onClick={c2} >B. A strong tequila scent beckons from a nearby chamber.</button>
            </div>
          </>
        )
      }
